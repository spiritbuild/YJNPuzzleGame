...
static const CGFloat MBDefaultLblFontSize = 16.f;
static const CGFloat MBDefaultDetailsLblFontSize = 12.f;
static const CGFloat MBHideDelayDuration = 1.5f;
...
+ (instancetype)showMessageInView:(UIView *)view withText:(NSString *)hudText {
    BOOL hasKeyBoard = NO;
    UIWindow *windowV = [[[UIApplication sharedApplication] delegate] window];
    ...
    if (hasKeyBoard) {
        hud = [MBProgressHUD showHUDAddedTo:windowV animated:YES];
    }
    else {
...
- (void)setupViews {
    ...
    label.font = [UIFont boldSystemFontOfSize:MBDefaultLblFontSize];;
    _label = label;
    UILabel *detailsLbl = [UILabel new];
    detailsLbl.adjustsFontSizeToFitWidth = NO;
    detailsLbl.textAlignment = NSTextAlignmentCenter;
    detailsLbl.textColor = defaultColor;
    detailsLbl.numberOfLines = 0;
    detailsLbl.font = [UIFont boldSystemFontOfSize:MBDefaultDetailsLblFontSize];
    _detailsLbl = detailsLbl;
    UIButton *button = [MBProgressHUDRoundedButton buttonWithType:UIButtonTypeCustom];
    button.titleLabel.textAlignment = NSTextAlignmentCenter;
    button.titleLabel.font = [UIFont boldSystemFontOfSize:MBDefaultDetailsLblFontSize];
    [button setTitleColor:defaultColor forState:UIControlStateNormal];
    _button = button;
    for (UIView *view in @[label, detailsLbl, button]) {
...
- (void)updateViewsForColor:(UIColor *)color {
    ...
    self.detailsLbl.textColor = color;
...
- (void)updateConstraints {
    ...
    NSMutableArray *subviews = [NSMutableArray arrayWithObjects:self.topSpacer, self.label, self.detailsLbl, self.button, self.bottomSpacer, nil];
...
- (void)setLblText:(NSString *)labelText {
    MBMainThreadAssert();
...
- (void)setLblFont:(UIFont *)labelFont {
    MBMainThreadAssert();
...
- (void)setLblColor:(UIColor *)labelColor {
    MBMainThreadAssert();
    self.label.textColor = labelColor;
}
- (NSString *)detailsLblText {
    return self.detailsLbl.text;
}
- (void)setDetailsLblText:(NSString *)detailsLblText {
    MBMainThreadAssert();
    self.detailsLbl.text = detailsLblText;
}
- (UIFont *)detailsLblFont {
    return self.detailsLbl.font;
}
- (void)setDetailsLblFont:(UIFont *)detailsLblFont {
    MBMainThreadAssert();
    self.detailsLbl.font = detailsLblFont;
}
- (UIColor *)detailsLblColor {
    return self.detailsLbl.textColor;
}
- (void)setDetailsLblColor:(UIColor *)detailsLblColor {
    MBMainThreadAssert();
    self.detailsLbl.textColor = detailsLblColor;
}
- (CGFloat)opacity {
    return _opacity;
}
